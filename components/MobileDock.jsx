...
import { 
  LayoutDashboard, ListChecks, Rocket, Zap, BookOpen
} from 'lucide-react';
...
export default function MobileDock() {
  ...
  const dockItems = [
    ...
    { icon: BookOpen, path: '/app/learning', label: 'Learning' },
    { icon: Rocket, path: '/app/missions', label: 'Missions' },
            ...
            >
              {active && (
                <motion.div
                  ...
                  className="absolute -inset-1 bg-[#FF6B2C]/10 rounded-xl border border-[#FF6B2C]/20 shadow-[0_0_15_rgba(255,107,44,0.2)]"
