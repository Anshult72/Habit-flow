...
import { Crown, Flame, Zap, Trophy, TrendingUp, Award, Star, Target, Swords } from 'lucide-react';
    ...
    >
      ...
      <div className={`relative rounded-3xl p-7 md:p-9 lg:p-10 backdrop-blur-xl flex flex-col items-center text-center border border-white/[0.05] ${
        ...
        <p className={`text-xs font-medium tracking-wide mb-4 ${
          isChampion ? 'text-[#FF8C42]' : 'text-text-muted'
        }`}>
          {user.title}
        </p>
        ...
        <div className="mb-5">
          ...
          <p className="text-[11px] text-text-muted uppercase tracking-widest mt-0.5">Productivity Score</p>
        </div>
        ...
        <div className="flex items-center justify-center gap-4 mb-5 w-full">
          ...
          <div className="text-center">
            ...
            <p className="text-[10px] text-text-muted uppercase tracking-wider">Rate</p>
          </div>
        </div>
      ...
      <div className={`relative flex items-center gap-4 md:gap-6 px-6 md:px-8 py-5 rounded-2xl backdrop-blur-lg transition-all duration-300 ${
        ...
        <div className="hidden sm:flex items-center gap-5 flex-shrink-0">
          <div className="text-center min-w-[48px]">
            ...
            <p className="text-[9px] text-text-muted uppercase tracking-wider">Streak</p>
          </div>
          <div className="text-center min-w-[48px]">
            <p className="text-sm font-bold text-white/70">{user.xp}</p>
            <p className="text-[9px] text-text-muted uppercase tracking-wider">XP</p>
          </div>
          <div className="text-center min-w-[48px]">
            <p className="text-sm font-bold text-white/70">Lv.{user.level}</p>
            <p className="text-[9px] text-text-muted uppercase tracking-wider">Level</p>
          </div>
        </div>
        ...
        <div className="text-right flex-shrink-0 min-w-[60px]">
          ...
          <p className="text-[9px] text-text-muted uppercase tracking-wider">Score</p>
        </div>
        ...
        <div className="hidden md:block w-20 flex-shrink-0">
          ...
          <p className="text-[9px] text-text-muted text-right mt-0.5">{user.completion}%</p>
        </div>
      </div>
    </motion.div>
  );
...
export default function LeaderboardPage() {
  return (
    <div className="min-h-screen relative overflow-hidden">
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 lg:px-16 pt-16 md:pt-20 pb-20">
        {/* Section Header */}
        <motion.div
        ...
        >
          ...
          <div className="flex items-center justify-between px-8 mb-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-text-muted font-medium tracking-[0.1em] uppercase">Full Rankings</span>
            </div>
            <span className="text-xs text-text-muted/50 font-medium">Updated live</span>
          </div>
        ...
        >
          <div className="inline-flex flex-col items-center gap-4 bg-[#080808]/60 backdrop-blur-xl border border-white/5 hover:border-[#FF6B2C]/20 rounded-2xl px-12 py-10 transition-colors shadow-[0_20px_50px_rgba(0,0,0,0.4)]">
            <div className="w-14 h-14 rounded-2xl bg-[#FF6B2C]/5 flex items-center justify-center shadow-[0_0_15px_rgba(255,107,44,0.1)] relative group/cta-icon">
              <div className="absolute inset-0 bg-[#FF6B2C]/20 blur-xl rounded-full opacity-0 group-hover/cta-icon:opacity-100 transition-opacity" />
