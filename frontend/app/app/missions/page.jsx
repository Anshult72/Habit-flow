...
import { 
  ...
  X, Link2, TrendingUp, Activity
} from 'lucide-react';
import { differenceInSeconds, parseISO } from 'date-fns';
import useStore from '@/store/useStore';

export default function MissionCountdown() {
  const { missions, habits, addMission, deleteMission } = useStore();
      ...
      {missions.length > 0 && (
        ...
        >
          <div className="glass-card p-6 rounded-3xl border-white/5 flex items-center gap-6">
            ...
            <div>
              <p className="text-xs text-text-muted font-bold uppercase tracking-widest">Active Missions</p>
          ...
          <div className="glass-card p-6 rounded-3xl border-white/5 flex items-center gap-6">
            ...
            <div>
              <p className="text-xs text-text-muted font-bold uppercase tracking-widest">Total Momentum</p>
          ...
          <div className="glass-card p-6 rounded-3xl border-white/5 flex items-center gap-6">
            ...
            <div>
              <p className="text-xs text-text-muted font-bold uppercase tracking-widest">AI Readiness</p>
              <p className="text-3xl font-display font-bold text-green-500">Optimal</p>
            </div>
          </div>
        </motion.div>
      )}
      ...
      <section className="space-y-10">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4 text-sm text-text-muted">
            <span className="flex items-center gap-1.5"><div className="w-2 h-2 rounded-full bg-green-500" /> On Track</span>
            <span className="flex items-center gap-1.5"><div className="w-2 h-2 rounded-full bg-orange-500" /> Critical</span>
          </div>
        </div>
        ...
        {missions.length === 0 ? (
          <div className="py-20 flex flex-col items-center justify-center text-center space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-text-muted">The future belongs to those who define it. Create your first mission.</p>
            </div>
          </div>
        ) : (
      ...
      <div className="px-8 py-6 grid grid-cols-4 gap-2 relative z-10">
        {[
          ...
          <div key={i} className="bg-white/5 border border-white/10 rounded-2xl p-3 text-center">
            ...
            <p className="text-[8px] text-text-muted font-bold uppercase tracking-tighter">{unit.label}</p>
          </div>
        ))}
      </div>
      ...
      <div className="p-8 pt-0 space-y-6 relative z-10">
        <div className="space-y-2">
          <div className="flex justify-between items-end">
            <span className="text-[10px] text-text-muted font-black uppercase tracking-widest">Mission Momentum</span>
        ...
        <div className="flex items-center justify-between pt-4 border-t border-white/5">
          <div className="flex items-center gap-2">
            <div className="flex -space-x-2">
              {[1, 2, 3].map(i => (
                <div key={i} className="w-6 h-6 rounded-full bg-white/5 border border-[#050505] flex items-center justify-center text-[8px] text-text-muted">
                  <Activity size={10} />
                </div>
              ))}
            </div>
            <span className="text-[10px] text-text-muted font-bold uppercase">Linked Habits</span>
          </div>
          <button 
        ...
        <div className="p-12 space-y-10 max-h-[90vh] overflow-y-auto custom-scrollbar">
          <div className="flex justify-between items-start">
            <div className="space-y-2">
              ...
              <p className="text-text-muted uppercase tracking-[0.2em] text-xs font-bold">Constructing the future trajectory</p>
            </div>
    ...
    >
      ...
      <div className="relative z-10 text-center space-y-16 max-w-4xl px-6">
        ...
        >
          ...
          <p className="mt-6 text-text-muted uppercase tracking-widest text-[10px] font-bold">
