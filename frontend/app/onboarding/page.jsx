      ...
      <div className="flex-1 relative bg-[#050505] flex items-center justify-center p-6 md:p-12 overflow-hidden">
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div className="w-12 h-12 flex items-center justify-center transition-transform hover:scale-110 duration-500">
               <img src="/assets/eagle-logo-simplified.png" alt="Logo" className="w-10 h-10 object-contain drop-shadow-[0_0_15px_rgba(255,107,44,0.4)]" />
            </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex-1 z-10">
                        ...
                        <p className="text-[10px] text-text-muted/60 uppercase tracking-widest mt-0.5">{item.desc}</p>
                      </div>
      ...
      <div className="grid grid-cols-2 gap-8 flex-1">
        {[
          ...
          <div key={i} className={`p-8 rounded-[2rem] border border-white/5 ${note.color} flex flex-col gap-4 relative overflow-hidden group`}>
             ...
             <p className="text-sm text-text-muted leading-relaxed whitespace-pre-line">{note.text}</p>
        ...
        {[
          ...
          <div key={i} className={`flex items-center justify-between p-6 rounded-2xl border transition-all ${item.checked ? 'bg-white/[0.01] border-white/5 opacity-40' : 'bg-white/[0.03] border-white/10 shadow-lg'}`}>
            <div className="flex items-center gap-6">
               ...
               <div>
                 <p className={`font-bold ${item.checked ? 'line-through text-text-muted' : 'text-white'}`}>{item.item}</p>
                 <span className="text-[10px] text-text-muted uppercase tracking-widest">{item.cat}</span>
               </div>
            </div>
          ...
          {[
            ...
            <div key={i} className="glass-card p-8 rounded-3xl border border-white/5 flex flex-col gap-6 relative overflow-hidden group">
               ...
               <div>
                  ...
                  <p className="text-sm text-text-muted font-mono">{item.price}</p>
               </div>
    ...
    <div className="h-full flex flex-col">
      <div className="flex items-center justify-between mb-12">
         <div className="space-y-1">
            ...
            <p className="text-text-muted text-sm">34 hours completed this month</p>
         </div>
          ...
          <div key={i} className={`p-6 rounded-2xl border flex items-center justify-between group transition-all ${item.status === 'Active' ? 'bg-[#FF6B2C]/5 border-[#FF6B2C]/20 shadow-xl' : 'bg-white/[0.02] border-white/5 opacity-50'}`}>
            <div className="flex items-center gap-6">
               ...
               <div>
                  ...
                  <p className="text-xs text-text-muted">{item.time} estimated</p>
               </div>
            </div>
            {item.status === 'Active' ? (
       ...
       <div className="flex items-center justify-between mb-16">
          ...
          <div className="flex items-center gap-4">
             <div className="text-right">
                <p className="text-[10px] text-text-muted uppercase font-bold tracking-widest">Heart Rate</p>
          ...
          {[
            ...
            <div key={i} className={`p-8 rounded-[2.5rem] border transition-all ${ex.active ? 'bg-[#FF6B2C]/10 border-[#FF6B2C]/40 shadow-2xl scale-105 z-10' : 'bg-white/[0.02] border-white/5 opacity-40'}`}>
               ...
               <div className="grid grid-cols-3 gap-4">
                  <div>
                     <p className="text-[8px] text-text-muted uppercase font-bold tracking-widest">Sets</p>
                     <p className="text-sm font-bold text-white">{ex.sets}</p>
                  </div>
                  <div>
                     <p className="text-[8px] text-text-muted uppercase font-bold tracking-widest">Reps</p>
                     <p className="text-sm font-bold text-white">{ex.reps}</p>
                  </div>
                  <div>
                     <p className="text-[8px] text-text-muted uppercase font-bold tracking-widest">Weight</p>
