...
export default function PricingSection() {
  return (
    <section id="pricing" className="relative pt-16 md:pt-20 pb-20 overflow-hidden">
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 lg:px-16">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-textMuted max-w-3xl mx-auto font-light leading-relaxed">
            ...
            >
              ...
              >
                ...
                <div className="mb-8">
                  ...
                  <p className="text-textMuted text-sm">{plan.tagline}</p>
                </div>
                ...
                <div className="mb-8 flex items-baseline gap-1">
                  ...
                  <span className="text-textMuted text-base font-light">{plan.period}</span>
                </div>
        ...
        >
          <p className="text-sm text-textMuted/60 tracking-[0.12em] uppercase font-medium mb-10">
