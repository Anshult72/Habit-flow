    ...
    <div className="space-y-8 pb-10">
      ...
      <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
        ...
        <div className="glass-card px-8 py-5 rounded-2xl border border-white/5 text-right">
          <p className="text-[10px] text-textMuted uppercase tracking-widest mb-1">Unlocked</p>
          <p className="text-4xl font-display font-bold text-white">
            {unlockedCount}<span className="text-textMuted text-xl">/{allAchievements.length}</span>
          </p>
        </div>
      </div>
              ...
              >
                ...
                <div className="flex items-start gap-4 relative z-10">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm text-textMuted leading-snug mb-3">{achievement.desc}</p>
