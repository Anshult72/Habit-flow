          ...
          <motion.div key={duel.id} initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="glass-card p-8 rounded-[3rem] border-white/5 relative overflow-hidden group">
            ...
            <div className="flex justify-between items-center mb-10 relative z-10">
              <div className="flex items-center gap-4">
                ...
                <div><p className="text-lg font-bold text-white">You</p><p className="text-[10px] text-textMuted font-bold uppercase tracking-widest">Rank #142</p></div>
              </div>
              ...
              <div className="flex items-center gap-4 text-right">
                <div><p className="text-lg font-bold text-white">{duel.opponent}</p><p className="text-[10px] text-textMuted font-bold uppercase tracking-widest">Rank #128</p></div>
            ...
            <div className="space-y-8 relative z-10">
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="p-4 rounded-2xl bg-white/5 border border-white/10 text-center">
                  <p className="text-[9px] text-textMuted font-bold uppercase tracking-widest mb-1">Time Remaining</p>
                  <p className="text-lg font-bold text-white">{duel.daysLeft || 0}d</p>
                </div>
                <div className="p-4 rounded-2xl bg-white/5 border border-white/10 text-center">
                  <p className="text-[9px] text-textMuted font-bold uppercase tracking-widest mb-1">Prize Pool</p>
                  <p className="text-lg font-bold text-white">500 XP</p>
                </div>
                <div className="p-4 rounded-2xl bg-white/5 border border-white/10 text-center">
                  <p className="text-[9px] text-textMuted font-bold uppercase tracking-widest mb-1">Badge</p>
