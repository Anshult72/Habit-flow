...
import { 
  Zap, Activity, Award, BarChart3, Brain, 
  Target, Flame, Calendar, Sparkles, ArrowRight,
  Shield, CheckCircle2, Globe, Users
} from 'lucide-react';
    ...
    <div className="relative min-h-screen pt-20">
      ...
      <section className="relative py-32 overflow-hidden bg-[#050505]">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center mb-24">
            ...
            <p className="text-lg text-textMuted max-w-2xl mx-auto font-light">Experience the most advanced productivity toolset ever built for the modern digital era.</p>
          </div>
      ...
      <section className="relative py-32 border-t border-white/5">
        <div className="max-w-7xl mx-auto px-6 md:px-12 text-center">
          ...
          <p className="text-lg text-textMuted max-w-2xl mx-auto font-light mb-16">Understand your momentum with precision. HabitFlow translates your efforts into actionable insights.</p>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="flex flex-col lg:flex-row-reverse items-center gap-20">
            <div className="flex-1">
              ...
              <p className="text-xl text-textMuted leading-relaxed mb-10 font-light">
              ...
              <div className="grid grid-cols-2 gap-8">
                <div>
                   ...
                   <p className="text-sm text-textMuted">Intelligent notification windows based on your alertness.</p>
                </div>
                <div>
                   <h4 className="text-white font-bold mb-2">Pattern Recognition</h4>
                   <p className="text-sm text-textMuted">Identify friction points in your routine before they break your streak.</p>
                </div>
              </div>
            </div>
            <div className="flex-1">
