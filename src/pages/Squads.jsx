      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-[10px] text-textMuted font-bold uppercase tracking-widest flex items-center gap-1"><Activity size={12} /> {squad.members.length} Members</span>
                    </div>
                  </div>
                </div>
                <div className="text-right">
                  <p className="text-[10px] text-textMuted font-bold uppercase tracking-widest mb-1">Squad Consistency</p>
              ...
              <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-10">
                {squad.members.map((member, i) => (
                  <div key={i} className="flex flex-col items-center gap-3">
                    ...
                    <p className="text-[10px] font-bold text-textMuted uppercase tracking-wider">{member}</p>
              ...
              <div className="flex items-center justify-between p-6 rounded-2xl bg-[#FF6B2C]/5 border border-[#FF6B2C]/10">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-textMuted mt-0.5">All members consistent today. +25% XP multiplier engaged.</p>
                  </div>
                </div>
        ...
        <div className="space-y-8">
          <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="glass-card p-8 rounded-[2.5rem] border-white/5 relative overflow-hidden group">
              ...
              {[
                ...
                <div key={i}>
                  <div className="flex justify-between text-[10px] font-bold uppercase tracking-widest mb-2">
                    <span className="text-textMuted">{obj.label}</span>
            ...
            <button className="w-full mt-8 py-3 rounded-xl border border-white/10 hover:border-[#FF6B2C]/40 text-[10px] font-bold text-textMuted hover:text-white uppercase tracking-widest transition-all">Mission Intel</button>
          </motion.div>
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="glass-card p-8 rounded-[2.5rem] border-[#FF6B2C]/20 bg-[#FF6B2C]/5 relative overflow-hidden group">
            ...
            <div className="relative z-10">
              ...
              <p className="text-xs text-textMuted mb-6 leading-relaxed">The most synchronized units in the HabitFlow ecosystem.</p>
              <div className="space-y-4">
                {[
                  ...
                  <div key={i} className="flex items-center justify-between p-3 rounded-xl bg-black/40 border border-white/5">
                    <div className="flex items-center gap-3">
                      <span className="text-xs font-bold text-textMuted">#{i+1}</span>
