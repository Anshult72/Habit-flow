    ...
    <div className="space-y-8 max-w-4xl pb-10">
      ...
      <div className="space-y-6 relative z-10">
        ...
        <div className="glass-card p-8 rounded-3xl border border-white/5 space-y-8">
          <div><h2 className="text-2xl font-display font-bold text-white">Data Portability</h2><p className="text-textMuted mt-1">Extract or inject operational intelligence.</p></div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <button onClick={handleExportJSON} className="flex items-center gap-3 bg-white/5 hover:bg-white/10 border border-white/10 p-5 rounded-2xl transition-all hover:border-[#FF6B2C]/50 group">
              ...
              <div className="text-left"><p className="text-white font-bold">Export JSON</p><p className="text-xs text-textMuted">Backup payload</p></div>
            </button>
            <button onClick={() => fileInputRef.current?.click()} className="flex items-center gap-3 bg-white/5 hover:bg-white/10 border border-white/10 p-5 rounded-2xl transition-all hover:border-[#FF6B2C]/50 group">
              ...
              <div className="text-left"><p className="text-white font-bold">Import JSON</p><p className="text-xs text-textMuted">Restore payload</p></div>
            ...
            <button onClick={handleExportCSV} className="flex items-center gap-3 bg-white/5 hover:bg-white/10 border border-white/10 p-5 rounded-2xl transition-all hover:border-[#FF6B2C]/50 group">
              ...
              <div className="text-left"><p className="text-white font-bold">Export CSV</p><p className="text-xs text-textMuted">Spreadsheet format</p></div>
            </button>
            <button onClick={() => csvInputRef.current?.click()} className="flex items-center gap-3 bg-white/5 hover:bg-white/10 border border-white/10 p-5 rounded-2xl transition-all hover:border-[#FF6B2C]/50 group">
              ...
              <div className="text-left"><p className="text-white font-bold">Import CSV</p><p className="text-xs text-textMuted">Load spreadsheets</p></div>
            ...
            <button onClick={handleExportPDF} className="flex items-center gap-3 bg-white/5 hover:bg-white/10 border border-white/10 p-5 rounded-2xl transition-all hover:border-[#FF6B2C]/50 group">
              ...
              <div className="text-left"><p className="text-white font-bold">Export PDF</p><p className="text-xs text-textMuted">Printable report</p></div>
            </button>
          </div>
        </div>
        ...
        <div className="glass-card p-8 rounded-3xl border border-white/5 space-y-6">
          ...
          <div className="flex items-center justify-between py-4 border-b border-white/5">
            <div><p className="font-bold text-white text-lg">Cinematic Mode</p><p className="text-sm text-textMuted">Permanent dark mode active.</p></div>
          ...
          <div className="flex items-center justify-between py-4 border-b border-white/5">
            <div><p className="font-bold text-white text-lg">Haptic Feedback</p><p className="text-sm text-textMuted">Vibrate on completion (mobile).</p></div>
            <div className="w-14 h-7 bg-white/10 rounded-full relative cursor-pointer border border-white/20"><div className="w-5 h-5 bg-textMuted rounded-full absolute left-1 top-1" /></div>
          </div>
        </div>
