          ...
          <div className="space-y-2">
            ...
            >
              ...
              <div>
                ...
                <p className="text-textMuted uppercase tracking-[0.3em] text-[10px] font-bold">Self-Improvement Protocol v4.0</p>
              </div>
            </motion.div>
          </div>
          ...
          {[
            ...
            >
              ...
              <div className="flex items-center gap-3">
                ...
                <p className="text-xs text-textMuted font-bold uppercase tracking-widest">{stat.label}</p>
              </div>
              ...
              {filteredSubjects.length === 0 && (
                ...
                >
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-textMuted max-w-sm mx-auto">Build your future one chapter at a time. Create your first subject to initiate the protocol.</p>
                  </div>
                </motion.div>
              )}
            </div>
    ...
    >
      ...
      <div className="p-8 pt-16 space-y-6 relative z-10">
        <div className="flex justify-between items-start">
          <div className="space-y-1">
            ...
            <p className="text-textMuted text-xs font-bold uppercase tracking-widest">
              {subject.chapters.length} Modules Detected
            </p>
          </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="space-y-1">
            <p className="text-[10px] text-textMuted uppercase font-bold tracking-widest">Total Study</p>
            <p className="text-xl font-display font-bold text-white">{subject.totalHours}h</p>
          </div>
          <div className="space-y-1 text-right">
            <p className="text-[10px] text-textMuted uppercase font-bold tracking-widest">Streak</p>
        ...
        <div className="space-y-2">
          <div className="flex justify-between items-end">
            <span className="text-[10px] text-textMuted font-black uppercase tracking-widest">Synaptic Completion</span>
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-4 mt-1">
                        <span className="text-[10px] text-textMuted uppercase font-bold tracking-widest flex items-center gap-1">
...
function CreateSubjectModal({ onClose, onAdd }) {
  ...
  const addChapterToForm = () => {
    ...
    setFormData({
      ...formData,
      chapters: [...formData.chapters, { ...chapterInput }]
    });
        ...
        <div className="p-12 space-y-10 max-h-[90vh] overflow-y-auto custom-scrollbar">
          <div className="flex justify-between items-start">
            <div className="space-y-2">
              ...
              <p className="text-textMuted uppercase tracking-[0.2em] text-xs font-bold">Constructing a new knowledge trajectory</p>
            </div>
                  ...
                  <div className="grid grid-cols-1 gap-2 max-h-32 overflow-y-auto custom-scrollbar pr-2">
                    {formData.chapters.map((ch, i) => (
                      <div key={i} className="flex items-center justify-between p-3 rounded-xl bg-white/5 border border-white/5 text-[10px] font-bold text-white/60">
                        <span>{ch.title}</span>
                        <span className="text-textMuted">{ch.duration}</span>
                      </div>
                    ))}
                  </div>
                </div>
        ...
        <div className="space-y-8">
          ...
          <div className="flex justify-center gap-6">
            <button 
              ...
              className="px-12 py-5 rounded-2xl bg-[#FF6B2C] text-white font-black uppercase tracking-widest shadow-[0_10px_40px_rgba(255,107,44,0.4)] hover:scale-105 transition-all"
            >
