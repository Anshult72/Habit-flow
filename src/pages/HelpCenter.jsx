...
export default function HelpCenter() {
  ...
  return (
    <div className="relative min-h-screen">
      ...
      {/* Main Content */}
      <main className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 lg:px-16 pt-24 md:pt-28 pb-24">
        {!activeCategory ? (
          <>
            {/* Header */}
            <motion.div
            ...
            >
              ...
              <p className="text-lg md:text-2xl text-textMuted max-w-2xl mx-auto font-light leading-relaxed">
              ...
              {filteredCategories.map((cat) => (
                ...
                >
                  ...
                  <div className="relative bg-[#080808]/80 backdrop-blur-xl rounded-2xl p-8 lg:p-9 flex flex-col h-full group-hover:bg-[#0A0A0A]/90 transition-colors duration-300 shadow-[0_8px_30px_rgba(0,0,0,0.3)]">
                    ...
                    {/* Description */}
                    <p className="text-sm md:text-base text-textMuted font-light leading-relaxed mb-6 flex-1">
                      {cat.description}
                    </p>

                    {/* Article count + arrow */}
                    <div className="flex items-center justify-between">
                      <span className="text-xs text-textMuted/60 font-medium">{cat.articles.length} articles</span>
            ...
            >
              ...
              <div className="text-center mb-14 relative z-10">
                ...
                <p className="text-base md:text-lg text-textMuted max-w-2xl mx-auto font-light leading-relaxed">
            ...
            >
              <div className="text-center mb-14">
                ...
                >
                  ...
                  <span className="text-xs font-medium tracking-[0.15em] uppercase">Platform Capabilities</span>
                </motion.div>
                <h2 className="text-3xl md:text-5xl lg:text-6xl font-display font-bold text-white tracking-tight mb-5">
                  Unique{' '}
                  <span className="text-transparent bg-clip-text" style={{ backgroundImage: 'linear-gradient(90deg, #FF6B2C, #FF8C42, #FFB347)' }}>
                ...
                <p className="text-base md:text-lg text-textMuted max-w-2xl mx-auto font-light leading-relaxed">
                  Discover the advanced capabilities that set HabitFlow apart from every other productivity tool.
                </p>
              </div>
              ...
              >
                {[
                  { icon: BarChart3, title: 'Timeline View', desc: 'Visualize your entire productivity journey on an interactive, scrollable timeline with daily, weekly, and monthly granularity.', color: '#FF6B2C' },
                  { icon: Monitor, title: 'Cross-Platform Support', desc: 'Seamlessly sync your habits, streaks, and analytics across desktop, tablet, and mobile devices in real time.', color: '#FF8C42' },
                  { icon: LayoutGrid, title: 'Smart Widgets', desc: 'Customizable dashboard widgets that surface the metrics most relevant to your personal productivity goals.', color: '#FFB347' },
                  { icon: StickyNote, title: 'Desktop Sticky Notes', desc: 'Pin quick habit reminders and motivational notes directly to your dashboard for constant visual reinforcement.', color: '#E85D04' },
                  { icon: FileText, title: 'Notes & Summary', desc: 'Attach rich-text notes to any habit entry and receive AI-generated weekly summaries of your performance trends.', color: '#FF6B2C' },
                  { icon: Keyboard, title: 'Productivity Shortcuts', desc: 'Power-user keyboard shortcuts for lightning-fast habit logging, navigation, and data entry across the platform.', color: '#FF8C42' },
                ].map((feat, i) => (
                  <motion.div
                    key={i}
                    variants={itemVariants}
                    ...
                    className="relative group rounded-2xl p-[1px]"
                  >
                    <div className="absolute inset-0 rounded-2xl bg-gradient-to-b from-white/8 via-white/[0.02] to-transparent opacity-30 group-hover:opacity-80 transition-opacity duration-500" />
                    <div className="absolute -inset-3 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none blur-2xl" style={{ background: `radial-gradient(circle, ${feat.color}08, transparent 70%)` }} />

                    <div className="relative bg-[#080808]/80 backdrop-blur-xl rounded-2xl overflow-hidden h-full group-hover:bg-[#0A0A0A]/90 transition-colors duration-300 shadow-[0_8px_30px_rgba(0,0,0,0.3)]">
                      {/* Decorative gradient banner */}
                      <div className="h-1 w-full" style={{ background: `linear-gradient(90deg, ${feat.color}40, transparent)` }} />

                      <div className="p-8 md:p-10">
                        <div className="flex items-start gap-5">
                          <div className="w-14 h-14 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-300" style={{ background: `${feat.color}12`, color: feat.color }}>
                            <feat.icon size={24} />
                          </div>
                          <div className="flex-1 min-w-0">
                            <h3 className="text-xl font-bold font-display text-white mb-2 group-hover:text-white transition-colors">{feat.title}</h3>
                            <p className="text-sm md:text-base text-textMuted font-light leading-relaxed">{feat.desc}</p>
                          </div>
                        </div>
                      </div>
                    </div>
            ...
            >
              ...
              <div className="relative bg-[#080808]/60 backdrop-blur-2xl border border-white/5 rounded-3xl p-10 md:p-20 text-center overflow-hidden">
                ...
                <div className="absolute top-6 left-8 w-20 h-20 rounded-2xl bg-[#FF6B2C]/5 blur-sm rotate-12 pointer-events-none" />
                <div className="absolute bottom-8 right-10 w-16 h-16 rounded-full bg-[#FF8C42]/5 blur-sm pointer-events-none" />
                <div className="absolute top-1/2 right-1/4 w-12 h-12 rounded-xl bg-[#E85D04]/4 blur-sm -rotate-12 pointer-events-none" />
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-base md:text-lg text-textMuted font-light max-w-lg mx-auto mb-12 leading-relaxed">
          ...
          >
            ...
            <div className="flex items-center gap-5 mb-12">
              ...
              <div>
                ...
                <p className="text-textMuted text-base font-light mt-2">{selectedCategory.description}</p>
              </div>
            </div>
