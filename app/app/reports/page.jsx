    ...
    <div className="min-h-screen text-white pt-6 pb-24 px-4 md:px-10">
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8 glass-card p-10 rounded-[2.5rem] border-white/5 flex flex-col space-y-8 h-[500px]">
          ...
          <div className="lg:col-span-4 space-y-8">
            <div className="glass-card p-8 rounded-[2.5rem] border-white/5 flex flex-col space-y-8 h-[500px]">
              <div className="space-y-1">
                <h3 className="text-xl font-display font-bold text-white tracking-tight">Sector Distribution</h3>
                <p className="text-[10px] text-textMuted uppercase font-black tracking-widest">Allocation by Category</p>
              </div>
              <div className="flex-1 flex items-center justify-center relative">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                  <p className="text-[10px] text-textMuted font-black uppercase tracking-widest">Efficiency</p>
                  <p className="text-4xl font-display font-bold text-white">92%</p>
                </div>
              </div>
              <div className="space-y-3">
                {Object.keys(categoryDistribution.labels).slice(0, 3).map((label, i) => (
                  <div key={i} className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <div className="w-2 h-2 rounded-full" style={{ backgroundColor: categoryDistribution.datasets[0].backgroundColor[i] }} />
                      <span className="text-xs font-bold text-white/60">{categoryDistribution.labels[label]}</span>
                    </div>
                    <span className="text-[10px] font-black text-white/20">32%</span>
                  </div>
                ))}
              </div>
            </div>
